...
import woensCollection from "../../assets/womens-collection.webp"
  ...
  return (
    ...
    <div className='container mx-auto flex flex-col md:flex-row gap-8'>
        <div className='relative flex-1'>
            <img src={woensCollection} alt="Womens Collection" className='w-full h-[700px] object-cover'/>
    ...
    {/*Mens Collection*/}
     <div className='relative flex-1'>
            <img src={mensCollection} alt="Mens Collection" className='w-full h-[700px] object-cover'/>
            <div className='absolute bottom-8 left-8 bg-white bg-opacity-90 p-4'>
